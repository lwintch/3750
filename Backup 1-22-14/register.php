							...
							if($password != $passconf){
					            ...
					            if(!preg_match($checkemail, $email)){
					            	...
					            	if($num1 == 1){
										...
										$res2 = mysql_query("INSERT INTO `users` (`username`, `password`, `email`, `active`, `rtime`) VALUES('".$username."','".$password."','".$email."', '1','".$registerTime."')");
										...
										echo "<center>You have successfully been registered!</center>";
									}
								}
							}
						}
